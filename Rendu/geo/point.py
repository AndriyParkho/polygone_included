...
class Point:
    ...
    def quadrant_inclusion(self, quadrant):
        """
        return if a point is in the given quadrant
        """
        return quadrant.min_coordinates[0] <= self.coordinates[0] <= quadrant.max_coordinates[0] \
                and quadrant.min_coordinates[1] <= self.coordinates[1] <= quadrant.max_coordinates[1]
